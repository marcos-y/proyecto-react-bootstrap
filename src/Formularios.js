        ...
        <>
            <Form onSubmit={handleSubmit}>
                <Form.Group >
                    ...
                    <Form.Control onChange={handleChangeNombre} value={nombre} type="email" placeholder="name@example.com" />
                </Form.Group>

                <Form.Group >
                    <Form.Label>Precio</Form.Label>
                    <Form.Control  onChange={handleChangePrecio}  value={precio} type="email" placeholder="name@example.com" />
                </Form.Group>
